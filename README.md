[![GitHub WidgetBox](https://github-widgetbox.vercel.app/api/profile?username=astafofo&data=followers,repositories,stars,commits&theme=viridescent)](https://github.com/astafofo)

## 🍕 About Me

<p align="center">
Focused on system internals, binary analysis, and software behavior at a low level.<br>
Reverse engineering, malware analysis, debugging unknown binaries, and legacy software research.<br>
</p>
...
<div align="center">
<img src="https://skillicons.dev/icons?i=cpp,cs,java,python,javascript,typescript,go,rust,php,bun,nodejs,html,css,bootstrap,bash,npm,mysql,mongodb,sqlite,docker,git,github,vscode,visualstudio,vercel,cloudflare,discord,linux,windows,kali" alt="skills logo"  />
</div>
